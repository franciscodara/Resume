<h1 align="center" style="font-size:600%;">Resume (Curriculum)</h1>
...
**Observações:** Introdução à inteligência artificial; testes de turing; estatística para inteligência artificial; probabilidade; estruturas condicionais e iterativas em python; funções e classes em python e mais.

**Início:** 10/2020	**Término:** 01/2020

<li>DESENVOLVIMENTO WEB MODERNO COMPLETO COM JAVASCRIPT/li>
  
**Instituição:** Cod3r cursos online

**Observações:** Dominio web, 14 cursos + projetos, javascript, angular, react, vue, node, html, css, jquery, bootstrap webpack gulp mysql.

Início: 04/2018	**Término:** 08/2019

<li>MICROSOFT POWER BI - BUSINESS INTELLIGENCE FOR BEGINNERS</li>

**Instituição:** Bizticscom king

**Observações:** Business intelligence & data/business analysis with microsoft power bi.

**Início:** 02/2019	**Término:** 06/2019

<li>DATA SCIENCE: VISUALIZAÇÃO DE DADOS COM PYTHON</li>

**Instituição:** Diego mariano, ph.d.

**Observações:** Visualização de dados usando a linguagem de programação python e a biblioteca pyplot.

Início: 06/2018	**Término:** 07/2018

<li>CURSO DE C++ - INTERMEDIÁRIO</li>

**Instituição:** Marcos castro - Udemy

**Observações:**	Programação em c++, utilização recursos avançados da linguagem e projetos.

**Início:** 08/2018	**Término:** 10/2018

<li>TERMINAL LINUX</li>

**Instituição:** Autodidata

**Observações:** Sou membro co-fundador da comunidade Deepin Brasil, um sistema Linux e sou atuante no mundo Linux desde 2013, inclusive ministrando treinamentos.

**Início:** 01/2013	**Término:** 12/2013
...
**Nível:** Advanced reading, intermediate fluency

<li>CHINÊS MANDARIM (TRADICIONAL)</li>
...
Disponibilidade para viagens; disponibilidade para me mudar (em oportunidades singulares); pretensão salarial flexível para pessoa física e jurídica; CLTou contrato PJ; flexibilidade de horário para presencial e remoto.

<h2>ÁREA DE ATUAÇÃO DAS EMPRESAS CONTRATANTES</h2>

Engenharia, devops, projetos, tecnologia , pesquisa e desenvolvimento.

<h2>OBSERVAÇÕES PESSOAIS</h2>

Fui publicitário por mais de 16 anos, em carreiras do setor político. Desde os 14 anos envolvido com programação autonomamente, aos 30 anos Resolvi mudar de área efetivamente e minhas experiências me tornam o melhor engenheiro de software que uma empresa pode agregar ao quadro com experiência em gestão de times e pessoas, adaptável as mais diversas metodologias tradicionais e ágeis.
